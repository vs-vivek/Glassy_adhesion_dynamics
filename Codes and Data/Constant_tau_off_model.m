...
params.eta = 1;          % Viscosity parameter CHANGE THIS PARAMETER TO CHANGE RELAXATION TIMESCALE
...
params.roff = 0.2;       % Baseline unbinding rate 
...
% Time parameters
params.Tfinal = 200;     % Total simulation time
